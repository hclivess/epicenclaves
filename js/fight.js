...
// Use the initial HP values from the first round of battle data
let playerCurrentHealth = battleData.rounds[0].player_hp;
let enemyCurrentHealth = battleData.rounds[0].enemy_hp;
...
function startBattle() {
    // Initialize health displays with initial HP values
    updateHealth(playerCurrentHealth, playerMaxHealth, playerHealth, playerHpDisplay);
    updateHealth(enemyCurrentHealth, enemyMaxHealth, enemyHealth, enemyHpDisplay);
