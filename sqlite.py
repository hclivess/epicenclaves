...
def create_user(user_data_dict, user, x_pos=1, y_pos=1, profile_pic=""):
    ...
    data = {
        ...
        "food": 500,
        "bismuth": 500,
        "equipped": [{"type": "axe", "min_damage": 1, "max_damage": 1, "durability": 100, "cls": "right_hand", "id": id_generator()}],
        "unequipped": [{"type": "dagger", "min_damage": 1, "max_damage": 2, "durability": 100, "cls": "right_hand", "id": id_generator()}],
        "pop_lim": 0,
        "alive": True,
        "online": True,
    }
